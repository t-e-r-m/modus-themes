...
;;;;; org
   ...
   `(org-level-1 ((,class ,@(modus-vivendi-theme-heading-foreground fg-main magenta-alt-other)
                          ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-4)
                          ,@(modus-vivendi-theme-heading-block magenta-nuanced-bg magenta-nuanced))))
   `(org-level-2 ((,class ,@(modus-vivendi-theme-heading-foreground fg-special-warm magenta-alt)
                          ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-3)
                          ,@(modus-vivendi-theme-heading-block red-nuanced-bg red-nuanced))))
   `(org-level-3 ((,class ,@(modus-vivendi-theme-heading-foreground fg-special-cold blue)
                          ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-2)
                          ,@(modus-vivendi-theme-heading-block blue-nuanced-bg blue-nuanced))))
   `(org-level-4 ((,class ,@(modus-vivendi-theme-heading-foreground fg-special-mild cyan)
                          ,@(modus-vivendi-theme-scale modus-vivendi-theme-scale-1)
                          ,@(modus-vivendi-theme-heading-block cyan-nuanced-bg cyan-nuanced))))
   `(org-level-5 ((,class ,@(modus-vivendi-theme-heading-foreground fg-special-calm green-alt-other)
                          ,@(modus-vivendi-theme-heading-block green-nuanced-bg green-nuanced))))
   `(org-level-6 ((,class ,@(modus-vivendi-theme-heading-foreground yellow-nuanced yellow-alt-other)
                          ,@(modus-vivendi-theme-heading-block yellow-nuanced-bg yellow-nuanced))))
   `(org-level-7 ((,class ,@(modus-vivendi-theme-heading-foreground red-nuanced red-alt)
                          ,@(modus-vivendi-theme-heading-block red-nuanced-bg red-nuanced))))
   `(org-level-8 ((,class ,@(modus-vivendi-theme-heading-foreground fg-dim magenta)
