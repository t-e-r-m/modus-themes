...
;;;;; org
   ...
   `(org-level-1 ((,class ,@(modus-operandi-theme-heading-foreground fg-main magenta-alt-other)
                          ,@(modus-operandi-theme-scale modus-operandi-theme-scale-4)
                          ,@(modus-operandi-theme-heading-block magenta-nuanced-bg magenta-nuanced))))
   `(org-level-2 ((,class ,@(modus-operandi-theme-heading-foreground fg-special-warm magenta-alt)
                          ,@(modus-operandi-theme-scale modus-operandi-theme-scale-3)
                          ,@(modus-operandi-theme-heading-block red-nuanced-bg red-nuanced))))
   `(org-level-3 ((,class ,@(modus-operandi-theme-heading-foreground fg-special-cold blue)
                          ,@(modus-operandi-theme-scale modus-operandi-theme-scale-2)
                          ,@(modus-operandi-theme-heading-block blue-nuanced-bg blue-nuanced))))
   `(org-level-4 ((,class ,@(modus-operandi-theme-heading-foreground fg-special-mild cyan)
                          ,@(modus-operandi-theme-scale modus-operandi-theme-scale-1)
                          ,@(modus-operandi-theme-heading-block cyan-nuanced-bg cyan-nuanced))))
   `(org-level-5 ((,class ,@(modus-operandi-theme-heading-foreground fg-special-calm green-alt-other)
                          ,@(modus-operandi-theme-heading-block green-nuanced-bg green-nuanced))))
   `(org-level-6 ((,class ,@(modus-operandi-theme-heading-foreground yellow-nuanced yellow-alt-other)
                          ,@(modus-operandi-theme-heading-block yellow-nuanced-bg yellow-nuanced))))
   `(org-level-7 ((,class ,@(modus-operandi-theme-heading-foreground red-nuanced red-alt)
                          ,@(modus-operandi-theme-heading-block red-nuanced-bg red-nuanced))))
   `(org-level-8 ((,class ,@(modus-operandi-theme-heading-foreground fg-dim magenta)
